...
public final class ReflectionManager {
	...
	public static Constructor<?> getConstructor(Class<?> clazz, Class<?>... parameterTypes)
		...
		int i;
		byte b;
		for (arrayOfConstructor = (Constructor[]) clazz
				.getConstructors(), i = arrayOfConstructor.length, b = 0; b < i;) {
	...
	public static Class<?> getCraftClass(String className) {
		try {
			return Class.forName("org.bukkit.craftbukkit."
					+ Bukkit.getServer().getClass().getPackage().getName().substring(23) + "." + className);
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
	...
	public enum PackageType {
		...
		CRAFTBUKKIT_ENTITY(CRAFTBUKKIT.getPath() + "entity"), CRAFTBUKKIT_EVENT(CRAFTBUKKIT.getPath() + "event"),
		CRAFTBUKKIT_GENERATOR(CRAFTBUKKIT.getPath() + "generator"), CRAFTBUKKIT_HELP(CRAFTBUKKIT.getPath() + "help"),
		CRAFTBUKKIT_INVENTORY(CRAFTBUKKIT.getPath() + "inventory"), CRAFTBUKKIT_MAP(CRAFTBUKKIT.getPath() + "map"),
		CRAFTBUKKIT_METADATA(CRAFTBUKKIT.getPath() + "metadata"), CRAFTBUKKIT_POTION(CRAFTBUKKIT.getPath() + "potion"),
		CRAFTBUKKIT_PROJECTILES(CRAFTBUKKIT.getPath() + "projectiles"),
		CRAFTBUKKIT_SCHEDULER(CRAFTBUKKIT.getPath() + "scheduler"),
		CRAFTBUKKIT_SCOREBOARD(CRAFTBUKKIT.getPath() + "scoreboard"),
		CRAFTBUKKIT_UPDATER(CRAFTBUKKIT.getPath() + "updater"), CRAFTBUKKIT_UTIL(CRAFTBUKKIT.getPath() + "util");
	...
	public enum DataType {
		...
		INTEGER(int.class, Integer.class), LONG(long.class, Long.class),
		CHARACTER(char.class, Character.class), FLOAT(float.class, Float.class),
